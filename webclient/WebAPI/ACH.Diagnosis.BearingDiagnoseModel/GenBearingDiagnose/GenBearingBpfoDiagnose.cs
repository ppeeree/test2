...
{
    public class GenBearingBpfoDiagnose : GenBearingDiagnoseBase
    {
        public SortedDictionary<double, double> frequencyDomainData { get; set; } //频谱数据
        public SortedDictionary<double, double> envelopeSpectrumData { get; set; } //包络数据
        /// <summary>
        ///  外圈损伤诊断
        /// </summary>
        ...
        /// <param name="sampleRate">采样率</param>override
        ...
        public override DiagnosisResult BearingDiagnosis(double[] waveData ,SortedDictionary<double, double> frequencyDomainData, SortedDictionary<double, double> envelopeSpectrumData, double sampleRate, double spd, double bpfiFaultCoefficient, double bpfoFaultCoefficient, double bsfFaultCoefficient, double ftfFaultCoefficient, string modeParaId, double constantSpeed, DataDescription dataDescription)
        {
            ...
            List<PkData> frequencyDoublingData = BearingFrequencyDoublingCalculate(spd, frequencyConversion, bpfoFaultCoefficient, bpfiFaultCoefficient, bsfFaultCoefficient, ftfFaultCoefficient,
            ...
            // 7.筛选倍频个数
            List<FrequencyDoublingData> siftFrequencyDoublingData = SiftFrequencyDoubling(bearingDiagnoseConfig.BandAvgThreshold, bearingDiagnoseConfig.FrequencyDoublingRangePoint, frequencyDomainData, intervalFrequency, frequencyDoublingData, screeningFrequencyConversion, 0, frequencyDoublingErrorRange, false);

            // 8.根据筛选倍频数据，进行轴承故障判断
            return BearingFaultJudgment(bearingDiagnoseConfig.FrequencyDoublingSiftNumber, bearingDiagnoseConfig.ContinuousFrequencyDoubling, siftFrequencyDoublingData, dataDescription, EnumBearingFaultType.OUTSIDECIRCLE);
