...
{
    public class GenBearingBpfiDiagnose : GenBearingDiagnoseBase
    {
        ...
        public override DiagnosisResult BearingDiagnosis(double[] waveData,SortedDictionary<double, double> frequencyDomainData, SortedDictionary<double, double> envelopeSpectrumData, double sampleRate, double spd, double bpfiFaultCoefficient, double bpfoFaultCoefficient, double bsfFaultCoefficient, double ftfFaultCoefficient, string modeParaId, double constantSpeed, DataDescription dataDescription)
        {
            BearingDiagnoseConfig bearingDiagnoseConfig = new BearingDiagnoseConfig()
            {
                ...
                FrequencyDoublingNumber = 35,//倍频个数
            ...
            List<PkData> frequencyDoublingData = BearingFrequencyDoublingCalculate(spd, frequencyConversion, bpfiFaultCoefficient, bpfoFaultCoefficient, bsfFaultCoefficient, ftfFaultCoefficient,
            ...
            // 8.根据筛选倍频数据，进行轴承故障判断
            return BearingFaultJudgment(bearingDiagnoseConfig.FrequencyDoublingSiftNumber, bearingDiagnoseConfig.ContinuousFrequencyDoubling, siftFrequencyDoublingData, dataDescription, EnumBearingFaultType.INNERCIRCLE);
        }
