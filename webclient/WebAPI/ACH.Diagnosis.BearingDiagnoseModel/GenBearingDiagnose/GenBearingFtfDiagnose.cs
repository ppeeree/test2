...
{
    public class GenBearingFtfDiagnose : GenBearingDiagnoseBase
    {
        /// <summary>
        ///  保持架损伤诊断 
        /// </summary>
        ...
        public override DiagnosisResult BearingDiagnosis(double[] waveData,SortedDictionary<double, double> frequencyDomainData, SortedDictionary<double, double> envelopeSpectrumData, double sampleRate, double spd, double bpfiFaultCoefficient, double bpfoFaultCoefficient, double bsfFaultCoefficient, double ftfFaultCoefficient, string modeParaId, double constantSpeed, DataDescription dataDescription)
        {
            BearingDiagnoseConfig bearingDiagnoseConfig = new BearingDiagnoseConfig()
            {
                ...
                FrequencyDoublingErrorPoint = 3,// 倍频误差点数
                BandAvgThreshold = 6,// 频带均值阈值
                FrequencyDoublingRangePoint = 60,// 倍频范围点数
                FrequencyDoublingSiftNumber = 10,// 倍频筛选个数
            ...
            List<PkData> frequencyDoublingData = BearingFrequencyDoublingCalculate(spd, frequencyConversion, ftfFaultCoefficient, bpfiFaultCoefficient, bpfoFaultCoefficient, bsfFaultCoefficient,
            ...
            // 8.根据筛选倍频数据，进行轴承故障判断
            return BearingFaultJudgment(bearingDiagnoseConfig.FrequencyDoublingSiftNumber, bearingDiagnoseConfig.ContinuousFrequencyDoubling, siftFrequencyDoublingData, dataDescription, EnumBearingFaultType.CAGE);
        }
