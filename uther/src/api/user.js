...
export const getButtons = () => request({
  url: '/NetApi/BladeSystem/buttons',
  method: 'get'
})
...
// 获取后台配置显示的首页路由
export const getHomeRoute = () => request({
  url: '/NetApi/BladeSystem/DefaultRoter',
  method: 'get'
})